...
(global["webpackJsonp"] = global["webpackJsonp"] || []).push([["components/bmusic"], {
        ...
        methods: {
          getComment: function getComment() {
            if (this.$store.state.nowsong) {
              var s = this.$store.state.nowsong;
              t.navigateTo({
                url: "../comment/comment?songid=" + s,
          ...
          sliderChange: function sliderChange(t) {
            var s = t.detail.value,
                o = .01 * s * this.$store.state.duration1;
            this.$store.commit("aloneballp"), this.$store.commit("jumpToTarget", o), this.balllocat = s;
          },
          ...
          nextmusic: function nextmusic() {
            ...
            this.songList.forEach(function (t, i) {
              if (t.id == n) {
                var e = i + 1 == o.songList.length ? 0 : i + 1;
                s = o.songList[e];
              }
            }), t.request({
              url: "http://39.107.80.8:5000/song/url?id=" + s.id,
              method: "GET",
              data: {},
              success: function success(t) {
          ...
          premusic: function premusic() {
            ...
            this.songList.forEach(function (t, i) {
              if (t.id == n) {
                var e = 0 == i ? o.songList.length - 1 : i - 1;
                s = o.songList[e];
              }
            }), t.request({
              url: "http://39.107.80.8:5000/song/url?id=" + s.id,
          ...
          choosetype: function choosetype(s, o) {
            this.curtype = s, this.$store.commit("getlooptype", s), t.showToast({
              title: "已切换至".concat(o),
              duration: 2e3,
              icon: "none"
            });
  ...
  d67d: function d67d(t, s, o) {},
  e813: function e813(t, s, o) {
    "use strict";
