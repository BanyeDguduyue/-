...
Z([3,'mask'])
Z([3,'bg'])
Z([[2,'+'],[[2,'+'],[1,'background-image:'],[[7],[3,'getimgbg']]],[1,';']])
Z([3,'__e'])
Z([3,'back'])
...
var hMB=_mz(z,'view',['bindtap',18,'class',1,'data-event-opts',2,'data-id',3],[],aDB,lCB,gg)
_(oHB,hMB)
}
else{oHB.wxVkey=2
var oNB=_mz(z,'view',['bindtap',22,'class',1,'data-event-opts',2,'data-id',3],[],aDB,lCB,gg)
_(oHB,oNB)
}
var cOB=_n('view')
_rz(z,cOB,'class',26,aDB,lCB,gg)
var oPB=_oz(z,27,aDB,lCB,gg)
_(cOB,oPB)
_(bGB,cOB)
oHB.wxXCkey=1
_(tEB,bGB)
...
var oPC=_mz(z,'view',['bindtap',18,'class',1,'data-event-opts',2],[],cGC,oFC,gg)
_(tKC,oPC)
}
else{tKC.wxVkey=2
var fQC=_mz(z,'view',['bindtap',21,'class',1,'data-event-opts',2],[],cGC,oFC,gg)
_(tKC,fQC)
}
var cRC=_n('view')
_rz(z,cRC,'class',24,cGC,oFC,gg)
var hSC=_oz(z,25,cGC,oFC,gg)
_(cRC,hSC)
_(aJC,cRC)
tKC.wxXCkey=1
_(oHC,aJC)
...
var c4E=_mz(z,'view',['bindtap',22,'class',1,'data-event-opts',2],[],lUE,oTE,gg)
_(bYE,c4E)
}
else{bYE.wxVkey=2
var h5E=_mz(z,'view',['bindtap',25,'class',1,'data-event-opts',2],[],lUE,oTE,gg)
_(bYE,h5E)
}
var o6E=_n('view')
_rz(z,o6E,'class',28,lUE,oTE,gg)
var c7E=_oz(z,29,lUE,oTE,gg)
_(o6E,c7E)
_(eXE,o6E)
bYE.wxXCkey=1
_(aVE,eXE)
...
var oZG=_mz(z,'bmusic',['bind:__l',35,'songList',1,'vueId',2],[],e,s,gg)
_(xYG,oZG)
_(hAG,xYG)
_(r,hAG)
return r
...
_(c2G,h3G)
var o4G=_mz(z,'view',['class',2,'style',1],[],e,s,gg)
_(c2G,o4G)
...
_(a8G,t9G)
_(c2G,a8G)
var e0G=_mz(z,'view',['class',11,'hidden',1],[],e,s,gg)
var bAH=_mz(z,'image',['class',13,'src',1],[],e,s,gg)
_(e0G,bAH)
_(c2G,e0G)
var oBH=_mz(z,'scroll-view',['bindtap',15,'class',1,'data-event-opts',2,'scrollTop',3,'scrollWithAnimation',4,'scrollY',5,'showScrollbar',6],[],e,s,gg)
var xCH=_mz(z,'view',['class',22,'style',1],[],e,s,gg)
var oDH=_v()
_(xCH,oDH)
var fEH=function(hGH,cFH,oHH,gg){
var oJH=_n('view')
_rz(z,oJH,'class',28,hGH,cFH,gg)
var lKH=_oz(z,29,hGH,cFH,gg)
_(oJH,lKH)
_(oHH,oJH)
return oHH
}
oDH.wxXCkey=2
_2z(z,26,fEH,e,s,gg,oDH,'item','idx','idx')
_(oBH,xCH)
_(c2G,oBH)
var aLH=_n('view')
_rz(z,aLH,'class',30,e,s,gg)
var tMH=_mz(z,'bmusic',['bind:__l',31,'vueId',1],[],e,s,gg)
_(aLH,tMH)
_(c2G,aLH)
_(r,c2G)
return r
